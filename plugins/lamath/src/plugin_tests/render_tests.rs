...
// Heavy render-stability tests (`render_clip_is_stable_…`, `offline_render_matches_realtime_…`,
// `ableton_style_four_bar_…`) live in `render_stability_tests.rs`, gated behind `integration-tests`.
