...
impl PluginMessageType for ResonatorMessageKind {
    fn id(self) -> &'static str {
        match self {
            Self::PatchUpdate => "ahara.resonator.patch_update",
            Self::TelemetryRequest => "ahara.resonator.telemetry_request",
            Self::TelemetryResponse => "ahara.resonator.telemetry_response",
        }
    }

    fn from_id(id: &str) -> Option<Self> {
        match id {
            "ahara.resonator.patch_update" => Some(Self::PatchUpdate),
            "ahara.resonator.telemetry_request" => Some(Self::TelemetryRequest),
            "ahara.resonator.telemetry_response" => Some(Self::TelemetryResponse),
            _ => None,
        }
    }
}
