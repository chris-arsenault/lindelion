...
pub struct BatteryOptions {
    ...
    /// (best-lag) tests. See [ADR-0018](../../../docs/adr/0018-nn-inference-allocation.md).
...
/// This is the NN-effect bar (ADR-0018): neural-network inference may allocate a bounded amount
