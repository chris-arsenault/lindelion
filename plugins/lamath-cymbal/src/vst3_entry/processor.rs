...
impl LamathCymbalVst3Processor {
...
impl IPluginBaseTrait for LamathCymbalVst3Processor {
...
impl IComponentTrait for LamathCymbalVst3Processor {
    ...
    unsafe fn getBusCount(&self, media_type: MediaType, dir: BusDirection) -> i32 {
        vst3_bus_count(&CYMBAL_BUSES, media_type, dir)
    }
    ...
    unsafe fn getBusInfo(
        ...
        fill_vst3_bus_info(&CYMBAL_BUSES, media_type, dir, index, bus)
    }
...
impl IAudioProcessorTrait for LamathCymbalVst3Processor {
...
impl IProcessContextRequirementsTrait for LamathCymbalVst3Processor {
