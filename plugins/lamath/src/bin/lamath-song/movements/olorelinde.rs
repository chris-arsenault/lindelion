//! Movement I — "Olórelindë (The Dream Ascending)", the 32-bar piece for the
//! four Lamath instrument families. This score is audition-approved and
//! regression-locked: its rendered stems must stay sample-identical.
//!
...
pub(crate) const METER: Meter = Meter::new(96.0, 4.0);
...
pub(crate) fn tracks(meter: Meter) -> Vec<TrackSpec> {
    ...
    vec![
        ...
        track(
            ...
            Voice::StringPick,
            string_bass(meter),
            rms_mix(-19.0, 0.0, 35.0, BED_RIDE),
        ),
        track(
            "modal-arp",
            Voice::ModalKeys,
