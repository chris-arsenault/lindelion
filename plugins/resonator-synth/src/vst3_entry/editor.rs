...
struct ResonatorEditorView {
    ...
    #[cfg(target_os = "macos")]
    editor: RefCell<Option<ahara_ui::resonator_vizia::ResonatorViziaEditor>>,
}
...
impl FixedSizePlugViewDelegate for ResonatorEditorView {
    unsafe fn attached(&self, parent: *mut c_void, size: ViewRect) -> tresult {
        #[cfg(target_os = "macos")]
        {
            ...
            *editor = Some(ahara_ui::resonator_vizia::ResonatorViziaEditor::attach(
                parent,
                host,
                ahara_ui::resonator_vizia::ResonatorEditorSize {
