use ahara_plugin_shell::vst3::{Vst3ClassRegistration, Vst3PluginFactory};
...
const CONTROLLER_NAME: &str = "Ahara Resonator Synth Controller";
...
ahara_plugin_shell::export_vst3_entrypoints!(resonator_vst3_factory());
