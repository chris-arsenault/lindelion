...
//! denoiser ([ADR-0019](../../docs/adr/0019-denoiser-native-onnx-runtime.md)). Inference is inline
//! with bounded allocation per [ADR-0018](../../docs/adr/0018-nn-inference-allocation.md): the
