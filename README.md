...
| ---- | ---- | ---- | ---- |
| Lamath | Sindarin, "echo" or "ringing of voices" | VST3 dual modal resonator instrument with MIDI input, optional sidechain note/expression input, and live excitation | [README](plugins/lamath/README.md), [spec](docs/plugins/lamath.md), [backlog](docs/plugins/lamath-backlog.md) |
| Lamath Cymbal | Extracted Lamath-family cymbal voice | VST3 shared-body idiophone / cymbal mesh instrument with one excitation slot and a seven-knob sparse UI | [README](plugins/lamath-cymbal/README.md), [spec](docs/plugins/lamath-cymbal.md) |
| Lamath Tube | Extracted Lamath-family reed tube voice | VST3 monophonic reed-driven tube instrument with eight key-switched articulation slots and a seven-knob sparse UI | [README](plugins/lamath-tube/README.md), [spec](docs/plugins/lamath-tube.md) |
| Lamath Stringed | Extracted Lamath-family string voice | VST3 picked/bowed string instrument with driver/body selectors, eight key-switched articulation slots, and a seven-knob sparse UI | [README](plugins/lamath-stringed/README.md), [spec](docs/plugins/lamath-stringed.md) |
