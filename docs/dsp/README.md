...
| [StringModel / ReedTube](waveguide.md) | `crates/lindelion-string/src/model.rs`, `crates/lindelion-wind/src/tube.rs` | Karplus-Strong-style digital waveguides with string/tube boundaries |
| [Waveguide resonator techniques](waveguide-techniques.md) | `crates/lindelion-string/src/`, `crates/lindelion-wind/src/` | Catalog of waveguide tuning, damping, and 2D-mesh techniques with implementation pointers ([ADR-0011](../adr/0011-waveguide-tube-tuning-and-2d-mesh.md)) |
...
| [Reassignment STFT](reassignment.md) | `crates/lindelion-dsp-utils/src/reassign.rs` | Forward-only method-of-reassignment analyzer: per-bin magnitude + time/frequency offsets ([ADR-0040](../adr/0040-cenedril-analysis-and-editor-delivery.md)) |
| [Lúmedir delivery metrics](delivery-metrics.md) | `plugins/lumedir/src/` | Off-thread speaking-rate, pitch-dynamism, pause-structure, and clarity estimators with fixture validation |
