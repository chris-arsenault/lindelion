...
inline per [ADR-0018](../docs/adr/0018-nn-inference-allocation.md). The denoiser and the voice gate
run on the native ONNX Runtime via `ort` ([ADR-0019](../docs/adr/0019-denoiser-native-onnx-runtime.md)) —
...
[ADR-0018](../docs/adr/0018-nn-inference-allocation.md); the default (non-streaming) DFN3 is not
