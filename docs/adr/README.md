...
| Range | Workstream |
| ----- | ---------- |
| 0032–0039 | Lamath resonator / shared-body idiophone (M2–M8) — **0032 used (tube driven-wind voice)** |
| 0040 | Cenedril visualizer — **done (M0–M6); used only 0040, 0041–0047 reclaimed** |
| 0048 | Lúmedir speech-coach — **done (M0–M6); used only 0048, 0049–0055 reclaimed** |
| 0041–0047, 0049+ | Unreserved — next new workstream |
