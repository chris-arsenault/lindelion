...
| `plugins/coach` | (Reserved, not yet a workspace member) Lúmedir — Windows-only passthrough Speech-Coach VST3 (delivery metrics: rate/cadence, pitch dynamism, pauses, clarity), egui editor. See [ADR-0023](docs/adr/0023-new-vsts-windows-only.md). |
