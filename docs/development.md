...
The Galad Windows host (`galad`) is target-gated and excluded from `make ci`; it is cross-compiled and checked with `make host-windows-check`. See [host/README.md](../host/README.md) and [architecture.md](architecture.md#windows-vst3-host-galad).
