...
- Document the remaining DSP modules: extracted string/wind/idiophone models, Lamath runtime, `Svf`, `DelayLine`, `FirstOrderAllpass`, smoothing types, onset detector, pitch detector, phrase analysis.
