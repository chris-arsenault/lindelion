//! The single-component object's `IEditController` face (ADR-0020-style: one COM object is
//! processor and controller; the editor reads the processor directly).
...
use super::{editor, processor::LamathTubeVst3Processor};
