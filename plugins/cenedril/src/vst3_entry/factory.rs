...
use super::{CenedrilVst3Controller, CenedrilVst3Processor, SUBCATEGORY};

const CONTROLLER_NAME: &str = VST3_BUNDLE_METADATA.controller_name;

const CENEDRIL_VST3_CLASSES: &[Vst3ClassRegistration] = &[
...
fn create_controller() -> ComPtr<FUnknown> {
    ComWrapper::new(CenedrilVst3Controller::new())
        .to_com_ptr::<FUnknown>()
...
mod tests {
    ...
    #[test]
    fn cenedril_registers_processor_and_controller_with_shared_factory() {
        ...
        assert_eq!(processor.cid, CenedrilVst3Processor::CID);
        ...
        assert_eq!(controller.cid, CenedrilVst3Controller::CID);
