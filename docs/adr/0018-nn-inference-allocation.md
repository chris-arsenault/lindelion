# 0018 — Neural-network inference runs inline, not on an audio-through worker
...
inference (the denoiser on the native ONNX Runtime per [ADR-0019](0019-denoiser-native-onnx-runtime.md),
