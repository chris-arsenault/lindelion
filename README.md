...
| ---- | ---- | ---- | ---- |
| Lamath | Sindarin, "echo" or "ringing of voices" | Implemented VST3 instrument | [README](plugins/lamath/README.md), [design](docs/plugins/lamath.md) |
...
| Glirdir | Sindarin `glir-` + `-dir`, "singer" or "song-bearer" | Core crate: capture, analysis, MIDI derivation, audition; VST3/UI pending | [README](plugins/glirdir/README.md), [design](docs/plugins/glirdir.md) |
